...
// Control behavior of agent by adjusting its parameter values
// Agents will share the same data so changes to the scriptable object data will affect all the agents that use the scriptable object
